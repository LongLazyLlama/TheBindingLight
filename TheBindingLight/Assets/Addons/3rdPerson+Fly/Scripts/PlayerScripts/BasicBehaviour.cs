...
public class BasicBehaviour : MonoBehaviour
{
	...
	private float sprint;                                  // Boolean to determine whether or not the player activated the sprint mode.
	...
	[HideInInspector]
	public float SprintAmount => sprint;
	...
	{
		return sprint > 0 && IsMoving() && CanSprint();
	}
